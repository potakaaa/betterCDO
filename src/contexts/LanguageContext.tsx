...
const baseTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    "hero-welcome": "Welcome to Better{{lguNickname}}.org",
  ...
  fil: {
    ...
    // Hero Section
    "hero-welcome": "Maligayang Pagdating sa Better{{lguNickname}}.org",
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const currentLguNickname = getLGUNickname(siteConfig);
  ...
  const defaultVariables = useMemo(() => ({
    ...
    lguNickname: currentLguNickname,
    ...
    fullLocation,
  }), [currentLguName, currentLguNickname, siteConfig, currentLabels, fullLocation]);
