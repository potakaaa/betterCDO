          ...
          <div className="flex items-center gap-4 flex-wrap md:justify-start justify-center">
            {displayHotlines.map((hotline) => (
              <a
                ...
                className="inline-flex items-center gap-1 text-white bg-transparent px-2.5 py-1 rounded-full whitespace-nowrap transition-all duration-200 hover:bg-white/30 hover:-translate-y-0.5"
              >
                <i
